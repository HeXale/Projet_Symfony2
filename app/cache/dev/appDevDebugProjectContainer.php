...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'SeveinfoFrontCarteBundle' => 'Seveinfo\\FrontCarteBundle\\SeveinfoFrontCarteBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'e21406457',
            'database_user' => 'e21406457',
            'database_password' => 'e21406457',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'e21406457', 'user' => 'e21406457', 'password' => 'e21406457', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Seveinfo/FrontCarteBundle/Entity'))), 'Seveinfo\\FrontCarteBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SeveinfoFrontCarteBundle' => 'Seveinfo\\FrontCarteBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f4e592ae377e417ea0639171e1b830cbb48b2e224457912ec68836b79306bc63');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Seveinfo/FrontCarteBundle/Resources/views'), 'SeveinfoFrontCarte');
