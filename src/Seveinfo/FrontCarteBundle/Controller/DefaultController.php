...
class DefaultController extends Controller
{
   ...
   public function idClientAction ($idclient)
   {
    //Récupérer le repository
        $repository = $this->getDoctrine()
                           ->getManager()
        ...
        //récup donnée
        $montants = $repository->findbyClient($id);
        $coupons = $repository->findbyClient($id);

        return $this->render('SeveinfoFrontCarteBundle:Default:idclient.html.twig',
         array('montants' => $montants, 'coupons' => $coupons));
   }
